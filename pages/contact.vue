    ...
    <section class="py-16 md:py-24 bg-base-100">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div class="space-y-8">
            <div>
              <h2 class="text-2xl font-bold font-headings text-neutral mb-4">Contact <span class="text-primary">SquadCoders</span></h2>
              <p class="text-squad-medium-gray mb-6">
            ...
            <div class="flex items-start space-x-4">
              <div class="flex-shrink-0">
                <div class="p-3 bg-primary rounded-full text-white">
              ...
              <div>
                <h3 class="text-lg font-semibold font-headings text-neutral">Our Office</h3>
                <p class="text-squad-medium-gray">123 Coding Lane, Dev City, TX 75001</p>
                <p class="text-squad-medium-gray">United States</p>
              </div>
            </div>

            <div class="flex items-start space-x-4">
              <div class="flex-shrink-0">
                <div class="p-3 bg-secondary rounded-full text-white">
                  <!-- SVG Icon for Email -->
              ...
              <div>
                <h3 class="text-lg font-semibold font-headings text-neutral">Email Us</h3>
                <p class="text-squad-medium-gray hover:text-secondary transition-colors"><a href="mailto:contact@squadcoders.dev">contact@squadcoders.dev</a></p>
                <p class="text-squad-medium-gray hover:text-secondary transition-colors"><a href="mailto:support@squadcoders.dev">support@squadcoders.dev</a></p>
              </div>
            </div>

            <div class="flex items-start space-x-4">
              <div class="flex-shrink-0">
                <div class="p-3 bg-accent rounded-full text-white">
                  <!-- SVG Icon for Phone -->
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" /></svg>
                </div>
              </div>
              <div>
                <h3 class="text-lg font-semibold font-headings text-neutral">Call Us</h3>
                <p class="text-squad-medium-gray">(555) 123-4567 (Sales)</p>
                <p class="text-squad-medium-gray">(555) 987-6543 (Support)</p>
              </div>
            </div>
             <!-- Placeholder for a map -->
            <div class="pt-6">
                <h3 class="text-lg font-semibold font-headings text-neutral mb-2">Find Us Here</h3>
                <div class="aspect-w-16 aspect-h-9 bg-base-300 rounded-lg shadow">
                    <iframe
          ...
          <!-- Contact Form -->
          <div class="bg-base-200 p-8 md:p-10 rounded-lg shadow-lg">
            <h2 class="text-2xl font-bold font-headings text-neutral mb-6">Send Us a <span class="text-secondary">Message</span></h2>
            <form @submit.prevent="handleSubmit" class="space-y-6">
              <div>
                <label for="name" class="label">
                  <span class="label-text text-squad-dark-gray">Full Name</span>
                </label>
                <input type="text" id="name" v.model="form.name" placeholder="John Doe" class="input input-bordered w-full focus:input-primary" required />
              </div>
              <div>
                <label for="email" class="label">
                  <span class="label-text text-squad-dark-gray">Email Address</span>
                </label>
                <input type="email" id="email" v-model="form.email" placeholder="john.doe@example.com" class="input input-bordered w-full focus:input-primary" required />
              </div>
              <div>
                <label for="service" class="label">
                  <span class="label-text text-squad-dark-gray">Service of Interest (Optional)</span>
                </label>
              ...
              <div>
                <label for="message" class="label">
                  <span class="label-text text-squad-dark-gray">Your Message</span>
                </label>
              ...
              <div>
                <button type="submit" class="btn btn-primary btn-block">
                  ...
                  <!-- <span v-if="submitting" class="loading loading-spinner loading-sm ml-2"></span> -->
                </button>
              </div>
            </form>
            <p v-if="submittedMessage" class="mt-4 text-sm text-success">{{ submittedMessage }}</p>
          </div>
        </div>
      </div>
    </section>
...
// const submitting = ref(false); // For loading state

const handleSubmit = async () => {
  // This is a placeholder. In a real app, you'd send data to a backend.
...
onMounted(() => {
  // Pre-fill service if query parameter exists
